...
interface SelectProps extends RdxSelect.SelectProps {
  children: ReactNode
  placeholder: string
}
    ...
    <RdxSelect.Root {...props}>
      ...
      <RdxSelect.Portal>
        <RdxSelect.Content
          ...
          position='popper'
          sideOffset={8}
          className='z-10 shadow-sm overflow-hidden rounded-lg border border-zinc-200 bg-white w-[--radix-select-trigger-width]'>
